...
namespace Backend.Migrations
{
    ...
    [Migration("20260831064801_AddPersistentGapStateAndWorkerHeartbeats")]
    partial class AddPersistentGapStateAndWorkerHeartbeats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Data.KlineGapState", b =>
                {
                    ...
                    b.HasIndex("Symbol", "Timeframe", "StartOpenTimeMs", "EndOpenTimeMs")
                        .IsUnique();

                    b.ToTable("KlineGapStates");
                });
            ...
            modelBuilder.Entity("Backend.Data.WorkerHeartbeat", b =>
                {
